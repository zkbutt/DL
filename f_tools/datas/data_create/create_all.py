...
from f_tools.datas.data_create.tools.check_jpgAndxml import checkJpgXml
from f_tools.datas.data_create.tools.create_main import create_main_txts
from f_tools.datas.data_create.tools.voc_label import gen_voc_lable
from f_tools.datas.data_create.tools.make_for_yolov3_torch import make_for_torch_yolov3
...
if __name__ == "__main__":
    ...
    jpegimages_dir = os.path.join(path_root,r".\JPEGImages")  # 图片保存位置
    annotations_dir = os.path.join(path_root,r".\Annotations")  # 标注文件保存位置
    ...
    dir_label = os.path.join(path_root,r".\voc_labels")

    dir1_train = os.path.join(path_root,r".\images\train2014")
    dir1_val = os.path.join(path_root,r".\images\val2014")
    dir2_train = os.path.join(path_root,r".\labels\train2014")
    dir2_val = os.path.join(path_root,r".\labels\val2014")

    main_trainval = os.path.join(path_root,r".\ImageSets\Main\trainval.txt")
    main_test = os.path.join(path_root,r".\ImageSets\Main\test.txt")
