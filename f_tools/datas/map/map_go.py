...
parser.add_argument('-na', '--no-animation', help="no animation is shown.", action="store_true")  # 不显示动画
parser.add_argument('-np', '--no-plot', help="no plot is shown.", action="store_true")  # 没有图示
parser.add_argument('-q', '--quiet', help="minimalistic console output.", action="store_true")  # 控制台输出
# argparse receiving list of classes to be ignored (e.g., python main.py --ignore person book)
parser.add_argument('-i', '--ignore', nargs='+', type=str, help="ignore a list of classes.")  # 忽略某类
# argparse receiving list of classes with specific IoU (e.g., python main.py --set-class-iou person 0.7)
parser.add_argument('--set-class-iou', nargs='+', type=str, help="set IoU for a specific class.")  # 设定iou
args = parser.parse_args()

'''自定义参数'''
args.no_animation = not CFG.ANIMATION  # 没有动画
args.no_plot = not CFG.PLOT_RES  # 只有日志
