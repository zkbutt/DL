...
def Xception(input_shape=[299, 299, 3], classes=1000):
    ...
    x = Conv2D(64, (3, 3), use_bias=False, name='block1_conv2')(x)  # (None, 147, 147, 64) 18432
    ...
    # block2
    # --------------------#
    # (None, 147, 147, 64)     149,149,64 -> 75,75,128 这是残差层
...
if __name__ == '__main__':
    ...
    print(plot_model(xception, to_file='f_xception.png', show_shapes=True))
