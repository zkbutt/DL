...
if __name__ == '__main__':
    ...
    python -m torch.distributed.launch --nproc_per_node=3  /home/fast120/ai_code/DL/tmp/pycharm_project_243/f_pytorch/t_multi_gpu_DDP.py
    python -m torch.distributed.launch --nproc_per_node=2 /home/win10_sys/tmp/pycharm_project_243/f_pytorch/t_multi_gpu_DDP.py
