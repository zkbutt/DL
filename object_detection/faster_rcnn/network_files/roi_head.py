...
from object_detection.faster_rcnn.network_files import boxes as box_ops, det_utils
    ...
    def assign_targets_to_proposals(self, proposals, gt_boxes, gt_labels):
        ...
        for proposals_in_image, gt_boxes_in_image, gt_labels_in_image in zip(proposals, gt_boxes, gt_labels):
            if gt_boxes_in_image.numel() == 0:  # 该张图像中没有gt框，为背景
                ...
                labels_in_image[bg_inds] = torch.tensor(0, device=labels_in_image.device)
                ...
                labels_in_image[ignore_inds] = torch.tensor(-1,
                                                            device=labels_in_image.device)  # -1 is ignored by sampler
